...
#En son satın alım yaptığı tarihtir.
rfm["frequency"] = df["order_num_total"]
#Toplam satın alma sayısıdır.
rfm["monetary"] = df["customer_value_total"]
#Parasal Değer, müşterinin bıraktığı parasal değer
...
#Recency'si kucuk olan bizim için kıymetlidir.
...
#Recency de küçük olan değerli M ve F de büyük olanlar iyi
